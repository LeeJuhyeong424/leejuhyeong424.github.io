...
## <i class="fas fa-lightbulb"></i> **블로그 목표**  

이 블로그는 **기술적인 지식**을 **공유**하고, 제 개발 여정과 **기술적 기록**을 남기는 것을 목표로 하고 있습니다. 다양한 프로젝트와 도전 과정을 기록하고, 이를 통해 독자들이 실용적인 정보를 얻을 수 있도록 돕는 공간입니다.
